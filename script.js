...
var users = {
	yohan: {
		...
		avatar: 'https://cdn.discordapp.com/avatars/275240603447721984/cfa93f0d1bc64b9d18f3af42879f444f.webp?size=4096'
	},
	spartan: {
		username: 'Spartan',
		nameColor: 'hsl(212, 51%, 59%)',
		bot: true,
		avatar: 'https://cdn.discordapp.com/avatars/747075491298803762/5f4d52a4469de12616578b5a6d12f734.webp?size=4096'
	}
};

var channelData = [{
		name: 'how-to-create-backups',
		selected: true,
		messages: [{
			type: 'input',
			text: ',backup-create',
			...
			user: users.spartan,
			embedData: {
				title: 'Spartan successfully created a backup.',
				pill: 'hsl(223, 7%, 20%)',
				thumb: 'https://cdn.discordapp.com/avatars/747075491298803762/5f4d52a4469de12616578b5a6d12f734.webp?size=4096',
				fields: [{
					value: "The backup ID has been sent to your DM\'s, make sure you don't have them disabled!"

				}, ]
			}
		}]
	}, {
		name: 'how-to-load-backups',
		messages: [{
			type: 'input',
			text: ',backup-load',
			user: users.yohan
			...
			embedData: {
				...
				thumb: 'https://cdn.discordapp.com/avatars/747075491298803762/5f4d52a4469de12616578b5a6d12f734.webp?size=4096',
				fields: [{
					value: 'To load backup, use ,backup-load 824749253296521219'
				}],
				footerIcon: users.yohan.avatar,
				footer: 'Requested By ' + users.yohan.username
			}
		}]
	...
	},
	{
		...
		messages: [{
			...
			user: users.spartan,
			embedData: {
				title: 'What happens after the backup has been loaded;',
				pill: '	hsl(223, 7%, 20%)',
				thumb: 'https://cdn.discordapp.com/avatars/747075491298803762/5f4d52a4469de12616578b5a6d12f734.webp?size=4096',
				fields: [{
          name: 'Info',
					value: 'After the backup has been loaded; messages, roles, server icon, channels etc.. will be restored, and that backup will be deleted permanently so make sure you make a backup right afterwards.'
				},
        {
          name: 'Extra Info',
          value: 'Please make sure you have Direct Messages enabled so I can send you the backup code. Message the developer if you back-up and you have them Disabled.'
        }
      ]
    }
  }]
},
  {
		...
		messages: [{
			...
			embedData: {
				...
				fields: [{
          name: 'Avatar',
          value: 'Shows the avatar of a mentioned user, or your own.'
        }, {
          name: 'Dev',
          value: 'Get to know the developer.'
        }, {
          name: 'Invites',
          value: 'Check how many people a user has invited.'
        }, {
          name: 'Anime',
          value: 'Searches for an anime on Kitsu.io!'
        }, {
          name: 'Color',
          value: 'Shows a random color or a preview of the given color!'
        }, {
          name: 'Edits',
          value: 'Fetches the recent edits of a message.'
        },
      {
        name: 'Enlarge',
        value: 'Makes an emote bigger if possible.'
      },
      {
        name: 'First Message',
        value: 'Get the first message on a channel.'
      },
      {
        name:'Invite',
        value: 'Sends you the Spartan invite link.'
      },
      {
        name:'Manga',
        value: 'Searches for a manga with Kitsu.io!',
      },
      {
        name: 'Bug Report',
        value: 'Sends a support message to Spartan\'s main server!',
      },
      {
        name: 'Urban',
        value: 'Searches for your query on Urban Dictionary!'
      },
      ]
      }
    }]
  },
  {
		...
		messages: [{
			...
			embedData: {
				...
				fields: [{
          name: 'Ban',
          value: 'Bans the given members ID or name.'
        }, {
          name: 'Ban-list',
          value: ' DMs you a list of banned users.'
        }, {
          name: 'Hackban',
          value: 'Bans the given user ID, even if they\'re not in the server.'
        }, {
          name: 'Kick',
          value: 'Kicks the given members ID or name.'
        }, {
          name: 'Lockdown',
          value: 'Prevents users from posting in the current channel!'
        }, {
          name: 'Mute',
          value: 'Mute the tagged user (if the admin has made the role "Muted")'
        },
      {
        name: 'Purge',
        value: 'Deletes up to 99 messages from the current channel.'
      },
      {
        name: 'Rule Setup',
        value: 'Set up default rules for your server.'
      },
      {
        name:'Unban',
        value: 'Unbans a user.'
  ...
  },
  {
		...
		messages: [{
			...
			user: users.spartan,
			embedData: {
				title: '- ROLE CONFIGURATION COMMANDS -',
				pill: 'hsl(223, 7%, 20%)',
				thumb: 'https://cdn.discordapp.com/avatars/747075491298803762/5f4d52a4469de12616578b5a6d12f734.webp?size=4096',
				fields: [{
          name: 'Give/Add-Role',
          ...
          name: 'Mass AddRole',
          value: 'Adds the role to everyone on the server!'
        }, {
          name: 'Mass RemoveRole',
          value: 'Removes the role from everyone on the server!'
        }, {
          name: 'Role Info',
          value: 'Get information about a role.'
        },
      ]
      }
    }]
  },
  {
		...
		messages: [{
			...
			embedData: {
				...
				fields: [{
          name: 'Give/Add-Role',
          value: 'Sends the current servers icon.'
        }, {
          name: 'Remove Role',
          value: 'See how many members are in the server.'
        }, {
          name: 'Mass AddRole',
          value: 'Shows all the permissions a user has.'
        }, {
          name: 'Mass RemoveRole',
      ...
      {
        name: 'Website',
        value: 'Sends you the Spartan website link.'
      },
      {
        name: 'Help',
        value: 'Shows you the help commands.'
      },
      {
        name: 'Ping',
        value: 'Shows you the Spartan\'s latency and response time.'
      },
      {
        name:'Prefix',
        value: 'Change Spartan\'s prefix.'
      },
      ]
      }
    }]
  },
  {
		...
		messages: [{
			...
			embedData: {
				...
				fields: [{
          name: 'Join',
          value: 'Spartan joins the Voice-Channel.'
        }, {
          name: 'Leave',
          value: 'Spartan leaves the Voice-Channel.'
        }, {
          name: 'Loop',
          ...
          name: 'Move',
          value: 'Move\'s a song in the queue.'
        }, {
          name: 'Music-Trivia',
          value: 'Starts a Music-Quiz where you have to guess either the artist or song name.'
        },
      {
        name: 'End-Trivia',
        value: 'Ends the Music-Trivia.'
      },
      {
        name: 'Now-Playing',
        value: 'Shows the current playing song.'
      },
      {
        name:'Pause',
      ...
      {
        name:'Play',
        value: 'Plays a song from youtube only.',
      },
      { 
        name: 'Queue',
        value: 'Shows you all the queue\'d up songs.'
      },
      {
        name: 'Remove',
        value: 'Remove a specific song in the queue.'
      },
      {
        name: 'Resume',
      ...
      {
        name: 'Skip-All',
        value: 'Skips all the songs in the queue.'
      },
      {
        name: 'Skip-To',
        value: 'Skip to a specific song in the queue, provide the song number as an argument!'
      },
      {
        name: 'Volume',
        value: 'Adjust the song volume.'
      },
      ]
      }
    }]
...
function parseBrackets(text) {
	...
	return {
		result: result,
		changedBrackets: changedBrackets
	};
}
